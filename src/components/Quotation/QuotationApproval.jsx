...
export default function QuotationApproval() {
  ...
  const allTableData = [
    { id: 1, qno: 'Q-1', date: '20-12-25', customer: 'C-1', sales: 'Raneesh', amount: '₹ 10,00,000', status: null },
    { id: 2, qno: 'Q-2', date: '20-12-25', customer: 'C-2', sales: 'Bala', amount: '₹ 15,00,000', status: null },
    { id: 3, qno: 'Q-3', date: '20-12-25', customer: 'ABC Traders', sales: 'Naveen', amount: '₹ 20,00,000', status: null },
    { id: 4, qno: 'Q-4', date: '20-12-25', customer: 'XYZ Corp', sales: 'Kumar', amount: '₹ 12,00,000', status: null },
    { id: 5, qno: 'Q-5', date: '20-12-25', customer: 'C-1', sales: 'Raneesh', amount: '₹ 18,00,000', status: null },
    { id: 6, qno: 'Q-6', date: '20-12-25', customer: 'C-2', sales: 'Bala', amount: '₹ 25,00,000', status: null },
    { id: 7, qno: 'Q-7', date: '20-12-25', customer: 'ABC Traders', sales: 'Naveen', amount: '₹ 30,00,000', status: null },
    { id: 8, qno: 'Q-8', date: '20-12-25', customer: 'C-1', sales: 'Raneesh', amount: '₹ 22,00,000', status: null },
  ];
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        <div style={{ flex: 1, padding: '24px', background: '#f5e6e8' }}>
          <div style={{ background: '#fff', borderRadius: '8px', padding: '24px', marginBottom: '10px' }}>
            <h3 style={{ marginBottom: '20px', fontSize: '20px' }}>Quotation Approval</h3>
              ...
              <div style={{ border: '1px solid #e5e7eb', marginTop: 89, borderRadius: '8px', overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  <thead style={{ background: '#f9fafb' }}>
                    <tr>
                      {['Sl No', 'Quotation No', 'Quotation Date', 'Customer Name', 'Sales Person', 'Total Cost', 'Print', 'Approval']
