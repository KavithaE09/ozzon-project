...
export default function PreviousMaterialIssueList() {
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={{ flex: 1, overflow: 'auto', backgroundColor: '#fce7e9', padding: '48px' }}>
          <div style={{ backgroundColor: 'white', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', padding: '40px' }}>
            ...
            <h1 style={{ fontSize: '48px', fontWeight: '700', color: '#111827', margin: '0 0 48px 0', textAlign: 'center' }}>Previous Material Issue List</h1>
