...
import React, { useState, useRef, useEffect } from "react"; import { useNavigate } from 'react-router-dom'; export default function Sales() {
  ...
  return (
    <div style={{ background: "#f6eaea", padding: 24 }}>
      <div style={{ background: "#fff", borderRadius: 8, padding: 24, marginBlockStart: 10, marginBottom: 10 }}>
        <label style={{ fontSize: 20, fontWeight: 600 }}>Sales</label>
